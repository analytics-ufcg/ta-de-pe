...
export const faqsData = [
  ...
  },
  {
    ...
    <p>Para compras do Governo Federal, são utilizados os dados abertos do Portal de Transparência mantido pela Controladoria-Geral da União (CGU). As informações são processadas com auxílio de código aberto desenvolvido pelo Brasil.io disponível no endereço <a href="https://github.com/turicas/transparencia-gov-br" target="_blank">https://github.com/turicas/transparencia-gov-br</a>.</p>
  ...
  },
  {
    ...
    texto: `<p>Nesta primeira fase do projeto, estamos divulgando apenas os contratos, licitações e empenhos dos municípios do Rio Grande do Sul, Pernambuco e do Governo Federal. Atualmente, apenas estes três entes disponibilizam dados com boa qualidade, especificamente o preço por item contratado, que permite realizar análises comparativas essenciais para o funcionamento do Tá de Pé.</p>
